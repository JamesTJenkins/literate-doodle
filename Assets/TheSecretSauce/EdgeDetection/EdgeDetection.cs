...
//using UnityEngine.Rendering.HDRP;
//
...
//
//			using var builder = renderGraph.AddRasterRenderPass<PassData>("EdgeDetection", out _);
//
...
//			edgeDetectionMaterial = CoreUtils.CreateEngineMaterial(Shader.Find("Hidden/EdgeDetection"));
//			if (edgeDetectionMaterial == null) {
